...
export function useTemplatesArray() {
  ...
  return [
    {
      ...
      totalWordsCount: 132,
      description: "Generate a catchy and engaging title for your blog post or article.",
      isFavorite: false,
    ...
    },
    {
      ...
      totalWordsCount: 25,
      description: "Create relevant tags for your blog posts to improve SEO and categorization.",
      isFavorite: true,
    ...
    {
      id: 3,
      title: t('youtubeHashtags'),
      icon: <FaHashtag className={iconStyle} />,
      totalWordsCount: 30,
      description: "Generate popular and trending hashtags for your YouTube videos.",
      isFavorite: false,
    ...
    },
    {
      ...
      totalWordsCount: 400,
      description: "Automatically generate code snippets based on your input or requirements.",
      isFavorite: true,
...
export const templatesArray = useTemplatesArray();
